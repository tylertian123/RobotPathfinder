...
/**
 * A class that represents a basic trajectory.
 * <p>
 ...
 * limited speed and acceleration, but unlimited jerk, and can move in any
 * direction without slowing down trajectory). In reality, because most
 * drivetrains have to slow down when turning, the basic trajectory cannot be
 * used. However, the generation of more advanced trajectories rely on a base
 * provided by this class.
 * </p>
 * <p>
 * Note: The generation for these trajectories are done in native code and take
 * some time to complete, as it is designed to handle complex paths with curves.
 * If the path is very simple (e.g. only driving straight forward or turning in
 * place), consider using a followable motion profile from the package
 * {@link com.arctos6135.robotpathfinder.motionprofile.followable.profiles}
 * instead, as they're much faster to generate.
 * </p>
...
public class BasicTrajectory extends Trajectory<BasicMoment> {
    ...
    /**
     * Creates a new {@link BasicTrajectory} with the specified robot specifications
     * and parameters.
     * 
    ...
    /**
     * Creates a new {@link BasicTrajectory} directly from a native pointer.
     * <p>
