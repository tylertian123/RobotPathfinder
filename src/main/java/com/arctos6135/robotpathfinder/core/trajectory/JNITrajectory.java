...
public abstract class JNITrajectory extends JNIObject {
	 ...
	 */
	abstract public Moment get(double t);
	/**
	 * Retrieves the path of this trajectory.
	 * @return The path of the trajectory
	 */
	abstract public JNIPath getPath();
	abstract public void clearPathCache();
	/**
	 ...
	 */
	abstract public RobotSpecs getRobotSpecs();
	/**
	 ...
	 */
	abstract public JNITrajectoryParams getGenerationParams();
