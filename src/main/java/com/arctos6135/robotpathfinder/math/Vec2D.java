...
public class Vec2D {
	...
	/**
	 * Constructs a new vector with the location of the waypoint. The heading is
	 * ignored.
	 * 
	...
	/**
	 * Multiplies this vector by a scalar and returns the result. Note that this
	 * vector is not modified in the process.
	 * 
	...
	/**
	 * Adds this vector to another vector and returns the result. Note that this
	 * vector is not modified in the process.
	 * 
	...
	/**
	 * Subtracts a vector from this vector and returns the result. Note that this
	 * vector is not modified int the process.
	 * 
	...
	/**
	 * Projects this vector onto another. Equivalent to
	 * <code>proj</code><i><sub>v</sub>u</i>, where <i>u</i> is this vector and
	 * <i>v</i> is the vector provided.
	 * 
