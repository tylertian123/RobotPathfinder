...
public class AdvancedTrapezoidalMotionProfile implements MotionProfile {
    ...
    public AdvancedTrapezoidalMotionProfile(RobotSpecs specs, double dist) {
        this(specs, dist, 0);
    }

    public AdvancedTrapezoidalMotionProfile(RobotSpecs specs, double dist, double initVel) {
        if (dist < 0) {
            reverse = true;
            dist = -dist;
            initVel = -initVel;
