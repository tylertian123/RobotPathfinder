...
public class DebugTests {
	...
	public static void main(String[] args) throws Exception {
        ...
        params.alpha = jniParams.alpha = 40.0;
        params.segmentCount = jniParams.segmentCount = 200;
        params.isTank = jniParams.isTank = true;
        params.pathType = jniParams.pathType = PathType.QUINTIC_HERMITE;
        long nanos1 = System.nanoTime();
        JNITankDriveTrajectory trajectory = new JNITankDriveTrajectory(robotSpecs, jniParams);
        long nanos2 = System.nanoTime();
        TankDriveTrajectory trajectory2 = new TankDriveTrajectory(robotSpecs, params);
        long nanos3 = System.nanoTime();
        trajectory.close();
        System.out.println("I AM ALIVE!");
